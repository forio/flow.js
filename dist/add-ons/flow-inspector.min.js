...
"use strict";var ContextExtractor=require("./context-extractor");module.exports=function($container){var template=require("./context-show.html");var $html=$(template);if(!window.Flow.channel.run.getCurrentConfig)return console.warn("You're using an older version of FlowJS which does not support viewing model context"),!1;var config=window.Flow.channel.run.getCurrentConfig();var modelType=config.model.split(".")[1];if("vmf"===modelType)return console.warn("Cannot view context for Vensim models"),!1;config.token="eyJhbGciOiJSUzI1NiJ9..iE2FccE3UqWBSmTQxraz0Isyb5w17aki1Q_BY_yM0qvdVLxIPq17oCtY3u8cL2uqLeIqvyvH7WRUvccadbh1fOisPX-V2NyfJg0sV82ti_yy4McDW-7ja8ilwP1QDXzsCOlMs4xyfCnd9KyJ7DiwYbrK2uhMvxV3NtFaH3WbrDLptf128zl3olLHN3XuyB0gvXHnfeitgDh-J79Kl7gC8JkGNK5_q--FddjJFVQz-dTwsPMzGQt-Tro7Hu45ACyn07B4IaFqIggmOtR9cUD7pao_YNzgMetLQ5mMz3ExIasWciqQ8E32S6S6s_Jp_3CpyZdCwlUWumI8yeZTsS9TAg";var file=new F.service.File(config);var promise=file.getFileContents(config.model,"model").then(function(response){var extractor=new ContextExtractor(config.model,response);return extractor});$container.on("click",".f-bind, .f-foreach, .f-on",function(evt){var $target=$(evt.target).is(".f-val")?$(evt.target):$(evt.target).parent().find(".f-val");var variableName=$target.text().trim();var isFunction=$target.parent().is(".f-on");promise.then(function(extractor){var context=extractor.showContext(variableName,isFunction);$html.find("pre").html(context)})}),$container.append($html)};
