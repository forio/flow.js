...
"use strict";module.exports=function(){var xOffset=0;var yOffset=0;var isDragged=!1;return{makeDraggable:function($element){$element.on("mousedown",function(evt){return evt.preventDefault(),xOffset=evt.clientX-$element.offset().left,yOffset=evt.clientY-$element.offset().top,isDragged=$element,!1}),$(window.document).on("mousemove",function(evt){return isDragged===$element?(evt.stopPropagation(),$element.css({top:evt.clientY-yOffset,left:evt.clientX-xOffset}),!1):void 0}),$(window.document).on("mouseup",function(evt){isDragged=!1})}}}();
},{}]},{},[1])
