...
"use strict";module.exports={fn:{start:function(reference){var regExp=new RegExp("^\\s*?function\\s+"+reference);return function(val){return regExp.test(val)}},end:function(val,startValue){return val.match(/^end/)}},variable:{start:function(reference){var regExp=new RegExp("^\\s*?(global\\s*)?"+reference+"\\s?=");return function(val){return regExp.test(val)}},end:function(val,startValue){return""===val.trim()||-1!==val.indexOf("=")}}};
},{}],6:[function(require,module,exports){
"use strict";module.exports={fn:{start:function(reference){var regExp=new RegExp("^def\\s+"+reference);return function(val){return regExp.test(val)}},end:function(val,startValue){return""===val.trim()}},variable:{start:function(reference){var regExp=new RegExp("^"+reference+"\\s?=");return function(val){return regExp.test(val)}},end:function(val,startValue){return""===val.trim()||-1!==val.indexOf("=")}}};
